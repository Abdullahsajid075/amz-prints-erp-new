...
<section class="section home-services premium-section-alt">
	<div class="container">
		...
		<div class="services-grid premium-services-grid fade-in">
			<?php foreach ( $services as $service ) : ?>
				<div class="service-card premium-service-card">
					...
					<span class="premium-feature-tag"><?php echo esc_html( studio_get_option( 'portfolio_premium_badge', 'Premium' ) ); ?></span>
				</div>
			<?php endforeach; ?>
		</div>
	</div>
