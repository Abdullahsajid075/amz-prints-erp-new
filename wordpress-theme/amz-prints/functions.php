...
require_once AMZ_PRINTS_DIR . '/inc/ecommerce.php';
...
function amz_prints_default_pages() {
	return array(
		...
		'account'          => array( 'title' => 'Account', 'template' => 'page-templates/template-account.php' ),
...
function amz_prints_maybe_upgrade_pages() {
	if ( get_option( 'amz_prints_pages_ver' ) === '2.4.0' ) {
		return;
	}
	amz_prints_ensure_pages();
	flush_rewrite_rules( false );
	update_option( 'amz_prints_pages_ver', '2.4.0' );
}
