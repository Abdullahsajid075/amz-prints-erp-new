<?php
/**
 * Header — full mobile nav + cart/account
 *
 * @package AMZ_Prints
 */
?><!DOCTYPE html>
			...
			<ul class="site-nav__list">
				...
				<li class="has-more">
					...
					<ul class="more-menu" id="more-menu">
						...
						<li><a href="<?php echo esc_url( home_url( '/account/' ) ); ?>">Login / Account</a></li>
					</ul>
				</li>
				<!-- Mobile-visible essentials (also in drawer) -->
				<li class="nav-mobile-extra"><a class="nav-link-main" href="<?php echo esc_url( home_url( '/cart/' ) ); ?>">Cart</a></li>
				<li class="nav-mobile-extra"><a class="nav-link-main" href="<?php echo esc_url( home_url( '/account/' ) ); ?>">Login</a></li>
				<li class="nav-mobile-extra"><a class="nav-link-main" href="<?php echo esc_url( home_url( '/checkout/' ) ); ?>">Checkout</a></li>
				<li class="nav-mobile-extra"><a class="nav-link-main" href="<?php echo esc_url( home_url( '/track-order/' ) ); ?>">Track Order</a></li>
			</ul>
		</nav>

		<div class="site-header__actions">
			<a class="header-icon-link" href="<?php echo esc_url( home_url( '/account/' ) ); ?>" data-auth-name>Login</a>
			<a class="header-icon-link" href="<?php echo esc_url( home_url( '/cart/' ) ); ?>" aria-label="Cart">
				Cart
				<span class="header-icon-link__badge" data-cart-count hidden>0</span>
			</a>
