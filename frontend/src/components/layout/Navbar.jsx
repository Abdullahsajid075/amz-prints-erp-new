...
const TITLE_MAP = [
  ...
  { match: '/crm', title: 'CRM' },
  { match: '/acknowledgments', title: 'Acknowledgments' },
  { match: '/acknowledgements', title: 'Acknowledgments' },
  { match: '/tasks', title: 'Internal Tasks' },
  { match: '/broadcasts', title: 'Broadcasts' },
  { match: '/purchases', title: 'Purchases' },
  { match: '/warehouse/products', title: 'Products' },
  { match: '/warehouse/inventory/settings', title: 'Inventory settings' },
  { match: '/warehouse/inventory', title: 'Inventory' },
  { match: '/pos/settings', title: 'POS settings' },
